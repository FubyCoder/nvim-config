local LINE_NUMBER_BACKGROUND = "#21252D"
...
vim.cmd(string.format('highlight FoldColumn guifg=#FFFFFF guibg=%s', LINE_NUMBER_BACKGROUND))
...
vim.cmd(string.format('highlight CursorLineNr guifg=%s guibg=%s', CURSOR_LINE_NUMBER_FOREGROUND, LINE_NUMBER_BACKGROUND))
